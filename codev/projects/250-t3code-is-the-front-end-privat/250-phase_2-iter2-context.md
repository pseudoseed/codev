### Iteration 1 Reviews
- claude: REQUEST_CHANGES — Hierarchy columns, guard and projector are correct and well covered, but two of phase 2's own acceptance criteria are tested by substitution rather than by the mechanism they name.
- opencode: COMMENT — Hierarchy fields, out-of-registry guard, and projection path match the phase; criterion 8b is simulated, not opened against the pre-fork binary.
