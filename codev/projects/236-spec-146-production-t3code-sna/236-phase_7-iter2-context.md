### Iteration 1 Reviews
- claude: APPROVE — Threat model, route rationales, failure matrix and README all reconciled with shipped code; the real dev-check credential is verifiably revoked on disk.
- opencode: REQUEST_CHANGES — Revocation trade and matrix rows landed; threat model and README still describe the pre-command world.
