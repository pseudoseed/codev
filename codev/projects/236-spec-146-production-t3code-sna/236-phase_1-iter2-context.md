### Iteration 1 Reviews
- claude: REQUEST_CHANGES — Wire shape, mapping and validator are correct, but the phase-1 no-thread row reason (criterion 5) is neither implemented nor tested.
- opencode: REQUEST_CHANGES — Mapping and vocabulary landed; criterion 5 and cooling-down when-and-why on the wire did not.
